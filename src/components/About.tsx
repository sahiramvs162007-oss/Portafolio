...
const traits = [
  {
    ...
    activeRingClass: "border-gold-400 shadow-[0_0_20px_rgba(201,152,46,0.45)] bg-gold-500/10",
  },
  {
    number: "02",
    ...
    activeRingClass: "border-green-400 shadow-[0_0_20px_rgba(74,222,128,0.45)] bg-green-500/10",
  },
  {
    number: "03",
    ...
    activeRingClass: "border-purple-400 shadow-[0_0_20px_rgba(192,132,252,0.45)] bg-purple-500/10",
  },
  {
    number: "04",
    ...
    activeRingClass: "border-blue-400 shadow-[0_0_20px_rgba(96,165,250,0.45)] bg-blue-500/10",
  },
  {
    number: "05",
    ...
    activeRingClass: "border-orange-400 shadow-[0_0_20px_rgba(251,146,60,0.45)] bg-orange-500/10",
  },
  {
    number: "06",
    ...
    activeRingClass: "border-teal-400 shadow-[0_0_20px_rgba(45,212,191,0.45)] bg-teal-500/10",
  },
];
        ...
        <div ref={ref} className="reveal mt-12 grid grid-cols-1 gap-16 md:grid-cols-2 md:items-center">
                      ...
                      <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="mt-3.5 font-body text-xs sm:text-[13px] font-bold leading-snug text-ink-900 dark:text-ink-50">
                          {isActive ? (
                            <>
                              {t.baseTitle}
                              <span className={t.textColorClass}>{t.accentTitle}</span>
                            </>
                          ) : (
                            <>
                              {t.baseTitle}
                              <span className="text-ink-600 dark:text-ink-300">{t.accentTitle}</span>
                            </>
                          )}
                        </h3>
                      </div>
          ...
          <div className="order-1 md:order-2 md:pl-6">
            ...
            <div className="inline-flex items-center gap-1.5 rounded-full border border-gold-500/30 bg-gold-500/5 px-3 py-1 font-body text-[11px] font-bold tracking-wider text-gold-400 uppercase">
              <svg className="h-3 w-3 text-gold-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold leading-tight text-ink-900 dark:text-ink-50 sm:text-5xl">
              Tecnóloga en <br />
              <span className="text-gradient-gold">Análisis y Desarrollo</span> <br />
              de Software
            </h2>
            ...
            <p className="mt-6 font-body text-base leading-relaxed text-ink-700/90 dark:text-ink-100/80">
              Soy Tecnóloga en Análisis y Desarrollo de Software. Disfruto crear aplicaciones que
              combinan lógica, diseño y usabilidad. Me interesa el desarrollo Full Stack y el
              diseño de interfaces intuitivas.
            </p>
            <p className="mt-4 font-body text-base leading-relaxed text-ink-700/90 dark:text-ink-100/80">
              Actualmente continúo aprendiendo y fortaleciendo mis conocimientos en nuevas
              tecnologías, buenas prácticas de código y arquitectura de software.
            </p>
        ...
        <div className="mt-20 rounded-2xl border border-gold-500/15 bg-ink-50/40 dark:bg-ink-900/40 p-6 shadow-sm backdrop-blur-md">
          <div className="grid grid-cols-2 gap-y-8 gap-x-4 md:grid-cols-4 md:gap-y-0">
            ...
            <div className="flex flex-col items-center text-center p-2 md:border-r md:border-gold-500/15">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gold-500/10 text-gold-400">
                <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 2L2 22l10-6 10 6L12 2z" />
                </svg>
              </div>
              <span className="mt-3 font-body text-2xl font-black text-ink-900 dark:text-ink-50">+ 8</span>
              <span className="mt-1 font-body text-xs text-ink-600 dark:text-ink-100/60">Proyectos desarrollados</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-2 md:border-r md:border-gold-500/15">
              ...
              <span className="mt-3 font-body text-2xl font-black text-ink-900 dark:text-ink-50">+ 3</span>
              <span className="mt-1 font-body text-xs text-ink-600 dark:text-ink-100/60">Tecnologías dominadas</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-2 md:border-r md:border-gold-500/15">
              ...
              <span className="mt-3 font-body text-2xl font-black text-ink-900 dark:text-ink-50">+ 1000</span>
              <span className="mt-1 font-body text-xs text-ink-600 dark:text-ink-100/60">Horas de código escrito</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-2">
              ...
              <span className="mt-3 font-body text-2xl font-black text-ink-900 dark:text-ink-50">100%</span>
              <span className="mt-1 font-body text-xs text-ink-600 dark:text-ink-100/60">Comprometida con el aprendizaje</span>
            </div>
          </div>
        </div>
      </div>
